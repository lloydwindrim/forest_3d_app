...
path = '/home/lloyd/Documents/datasets/lidar/low_res_ALS/saltwater_31B_1_2.las'
...
detector_addr = '/home/lloyd/Documents/projects/forest_3d_app/models/detection/hvp'
...
labels = rasterTreeDetector.sliding_window(detector_addr,xyz_data_gr,ground_pts=ground_pts,windowSize = [50,50],stepSize = 40)
